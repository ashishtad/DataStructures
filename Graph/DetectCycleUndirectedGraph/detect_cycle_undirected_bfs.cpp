...
/*
  Undirected grap cycle detection using BFS.
  Process each node by pushing to a queue as {node,parent}, mark the node as visited.
  Pop the node and traverse it's neighbours.
    Ignore the parent and push other non visited nodes.
